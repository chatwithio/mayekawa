 ...
 */
final class Version20220329103821 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE messages (id INT NOT NULL, wa_id VARCHAR(20) NOT NULL, whatsapp_message TEXT NOT NULL, message_type VARCHAR(2) NOT NULL, created TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
